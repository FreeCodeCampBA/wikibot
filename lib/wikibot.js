...
WikiBot.prototype._isMentioningLearningResources = function (message) {
  return message.text.toLowerCase().includes('libro') ||
        message.text.toLowerCase().includes('curso') ||
        message.text.toLowerCase().includes('tutorial') ||
        message.text.toLowerCase().includes('guia') ||
        message.text.toLowerCase().includes('recurso') ||
        message.text.toLowerCase().includes(this.name)
}
=======
WikiBot.prototype._isMentioningLearningResources = function(message) {
    return message.text.toLowerCase().includes("?") && 
      (message.text.toLowerCase().includes("libro") ||
       message.text.toLowerCase().includes("curso") ||
       message.text.toLowerCase().includes("tutorial") ||
       message.text.toLowerCase().includes("guia") ||
       message.text.toLowerCase().includes("recurso") ||
...
>>>>>>> 39676a4df6a4f3aec2bf7fa617d88e9cf3af3b4f
